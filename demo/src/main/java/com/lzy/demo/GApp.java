...
/**
 * ================================================
 * 作    者：  github 地址  https://github.com/jeasonlzy/
 * 版    本：1.0
 * 创建日期：2015/9/23
 * 描    述：
 * 修订历史：
 * ================================================
 */
public class GApp extends TinkerApplication implements ThemeUtils.switchColor{

    private static final String UPLOAD_URL = "http://xxxxxxxx";
    public static String MODE_PRENAME = "smt";
    ...
    public GApp() {
        super(ShareConstants.TINKER_ENABLE_ALL, "com.lzy.demo.MyApplicationLike",
