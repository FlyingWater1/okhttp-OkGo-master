...
public class MaterialItemAdapter extends BaseAdapter {
    ...
    public MaterialItemAdapter(Context context, List<MenuItemModel> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHold.menu_item_title.setText(items.get(position).getTitle());
        viewHold.menu_item_title.setBackgroundResource(items.get(position).getImageUrl());
