...
import com.lzy.demo.ui.material_query.entity.SplitBoard;
 ...
 * 生产过程查询
 */
public class MaterialProductiveProcessActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_productive_process);
        ButterKnife.bind(this);
        setView();
    }

    private void setView() {
        ((TextView)findView(R.id.tv_title)).setText("生产过程查询");
        //显示进度条
        ProgressDialogUtils.showProgressDialog(this, "数据加载中...");
        SplitBoard splitBoard = new SplitBoard();
        splitBoard.setPANEL_SN("1");
...
//                    productiveProcessAdapter = new ProductiveProcessAdapter(productiveProcessModels,MaterialProductiveProcessActivity.this);
//                    horizontalListView.setAdapter(productiveProcessAdapter);
                }else{
                    Toast.makeText(MaterialProductiveProcessActivity.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
