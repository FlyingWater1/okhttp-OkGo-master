...
public class Store_bindActivity extends BaseActivity {
    ...
    int images[] = new int[]{R.drawable.layout_gray_bg,R.drawable.layout_green_bg,R.drawable.layout_red_bg};

    String titles[] = new String[]{"按Reel ID绑定","按箱号绑定","按批次绑定"};
