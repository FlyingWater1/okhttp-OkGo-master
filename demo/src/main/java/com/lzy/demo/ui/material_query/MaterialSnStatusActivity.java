 ...
 * SN状态查询
 */
public class MaterialSnStatusActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_sn_status);
        ButterKnife.bind(this);
        setView();
    }

    private void setView() {
        ((TextView)findView(R.id.tv_title)).setText("SN状态查询");
        //显示进度条
...
//                    productiveProcessAdapter = new ProductiveProcessAdapter(productiveProcessModels,MaterialSnStatusActivity.this);
//                    horizontalListView.setAdapter(productiveProcessAdapter);
                }else{
                    Toast.makeText(MaterialSnStatusActivity.this, "获取WebService数据错误", Toast.LENGTH_SHORT).show();
                }
            }
        });
