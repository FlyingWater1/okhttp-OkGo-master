...
public class ScanResultActivity extends AestheticActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        smt_num = (EditText) findViewById(R.id.smt_num);
            ...
            if (requestCode == SCAN_REQUEST_CODE) {
                ...
                if (!TextUtils.isEmpty(isbn)) {
                    ...
                    if (isbn.contains("http")) {
                        ...
                        smt_num.setText(isbn);
                        smt_num.setSelection(isbn.length());//将光标移至文字末尾
