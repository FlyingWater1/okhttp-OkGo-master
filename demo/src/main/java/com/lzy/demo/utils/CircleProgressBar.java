...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mStyle = a.getInt(R.styleable.CircleProgressBar_styles, LINE);
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progress_text_sizes, UnitUtils.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        ...
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_progress_text_colors, Color.parseColor(COLOR_FFF2A670));
