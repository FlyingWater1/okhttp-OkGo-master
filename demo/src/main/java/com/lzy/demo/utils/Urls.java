...
public class Urls {
    ...
    public static final String URL_LIST = "http://192.168.50.100:7002/api/test";
    public static final String URL_LOGIN_TEXT = "http://192.168.50.100:7002/api/values?userName=MES001&password=888&language=chinese";
}
