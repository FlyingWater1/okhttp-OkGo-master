...
public class ActivityScanerCode extends ActivityBase {
    ...
    private void initDialogResult(Result result) {
        ...
        if (isNumeric(realContent)){
            ean_code.setText(realContent);
        }else{
            qr_code.setText(realContent);
        }
         ...
         * 扫码两次退出
         */
//        if ((ean_code.length()!=0) && (qr_code.length()!=0)){
//            RxToast.success("满了！"+((ean_code.length()!=0) && (qr_code.length()!=0)));
//            finish();
//        }
