...
public class ThemeHelper {
    ...
    public static final int CARD_BROWN_LIGHT = 0x9;
    public static final int CARD_BROWN = 0x10;
    public static final int CARD_CYAN_LIGHT = 0x11;
    public static final int CARD_CYAN = 0x12;
