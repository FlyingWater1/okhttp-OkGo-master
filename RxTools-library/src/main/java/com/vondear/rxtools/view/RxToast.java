...
public class RxToast {
    ...
    public static void info(@NonNull String message) {
        Tipinfo(getContext(), message, Toast.LENGTH_SHORT, true).show();
    }

    public static void info(@NonNull String message, int duration) {
        Tipinfo(getContext(), message, duration, true).show();
    }
    ...
    @CheckResult
    public static Toast Tipinfo(@NonNull Context context, @NonNull String message) {
        return Tipinfo(context, message, Toast.LENGTH_SHORT, true);
    }

    @CheckResult
    public static Toast Tipinfo(@NonNull Context context, @NonNull String message, int duration) {
        return Tipinfo(context, message, duration, true);
    }

    @CheckResult
    public static Toast Tipinfo(@NonNull Context context, @NonNull String message, int duration, boolean withIcon) {
